...
config :where_machines, WhereMachines.Repo,
  database: Path.expand("../where_machines_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :where_machines, WhereMachinesWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "/WFkbnz1WxCDN6NZAf7A84OOU77Q0Mhcmy0zkgN+Tyc/00FD768rPGVsYwMKNJoF",
  watchers: [
...
config :where_machines, WhereMachinesWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/where_machines_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
