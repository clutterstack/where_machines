defmodule FlyMachinesApi.Schemas.CreateVolumeRequest do
  ...
  def changeset(schema, attrs) do
    schema
    |> cast(attrs, [:compute, :compute_image, :encrypted, :fstype, :name, :region, :require_unique_zone, :size_gb, :snapshot_id, :snapshot_retention, :source_volume_id])
        |> cast_embed(:compute, with: &FlyMachinesApi.Schemas.FlyMachineGuest.changeset/2)
  end
end
