defmodule FlyMachinesApi.Schemas.FlyHTTPOptions do
  ...
  def changeset(schema, attrs) do
    schema
    |> cast(attrs, [:compress, :h2_backend, :headers_read_timeout, :idle_timeout, :response])
        |> cast_embed(:response, with: &FlyMachinesApi.Schemas.FlyHTTPResponseOptions.changeset/2)
  end
end
