...
defmodule FlyMachinesApi.Schemas.fly.MachineConfig do
  @schema %{
...
defmodule FlyMachinesApi.Schemas.fly.Duration do
...
defmodule FlyMachinesApi.Schemas.fly.TLSOptions do
  @schema %{
...
defmodule FlyMachinesApi.Schemas.fly.MachineInit do
  @schema %{
  tty: %{type: :boolean, required: false},
  exec: %{type: :list, items: %{type: :string, required: false}, required: false},
  cmd: %{type: :list, items: %{type: :string, required: false}, required: false},
...
defmodule FlyMachinesApi.Schemas.fly.HTTPOptions do
  @schema %{
  compress: %{type: :boolean, required: false},
  response: %{
    type: :map,
...
defmodule FlyMachinesApi.Schemas.fly.MachineServiceConcurrency do
  @schema %{
  type: %{type: :string, required: false},
  hard_limit: %{type: :integer, required: false},
  soft_limit: %{type: :integer, required: false}
...
defmodule FlyMachinesApi.Schemas.fly.MachineSecret do
...
defmodule FlyMachinesApi.Schemas.fly.MachinePort do
  @schema %{
  port: %{type: :integer, required: false},
  handlers: %{type: :list, items: %{type: :string, required: false}, required: false},
  start_port: %{type: :integer, required: false},
...
defmodule FlyMachinesApi.Schemas.fly.MachineHTTPHeader do
  @schema %{
  name: %{type: :string, required: false},
...
defmodule FlyMachinesApi.Schemas.fly.MachineGuest do
  @schema %{
  cpu_kind: %{type: :string, required: false},
  cpus: %{type: :integer, required: false},
  gpu_kind: %{type: :string, required: false},
...
defmodule FlyMachinesApi.Schemas.fly.StopConfig do
  @schema %{
  timeout: %{
    type: :map,
    keys: %{"time.Duration": %{type: :integer, required: false}},
...
defmodule FlyMachinesApi.Schemas.fly.MachineMount do
  @schema %{
  name: %{type: :string, required: false},
  path: %{type: :string, required: false},
  add_size_gb: %{type: :integer, required: false},
...
defmodule FlyMachinesApi.Schemas.fly.MachineMetrics do
...
defmodule FlyMachinesApi.Schemas.fly.dnsOption do
...
defmodule FlyMachinesApi.Schemas.fly.MachineService do
  @schema %{
  ports: %{
    type: :list,
    items: %{
...
defmodule FlyMachinesApi.Schemas.fly.MachineProcess do
  @schema %{
  env: %{type: :map, required: false},
  user: %{type: :string, required: false},
  exec: %{type: :list, items: %{type: :string, required: false}, required: false},
...
defmodule FlyMachinesApi.Schemas.fly.MachineCheck do
  @schema %{
  timeout: %{type: :map, required: false},
  port: %{type: :integer, required: false},
  type: %{type: :string, required: false},
...
defmodule FlyMachinesApi.Schemas.fly.ProxyProtoOptions do
...
defmodule FlyMachinesApi.Schemas.fly.File do
  @schema %{
  mode: %{type: :integer, required: false},
  guest_path: %{type: :string, required: false},
  raw_value: %{type: :string, required: false},
...
defmodule FlyMachinesApi.Schemas.fly.MachineRestart do
  @schema %{
  gpu_bid_price: %{type: :float, required: false},
  max_retries: %{type: :integer, required: false},
...
defmodule FlyMachinesApi.Schemas.fly.EnvFrom do
  @schema %{
  env_var: %{type: :string, required: false},
  field_ref: %{
    type: :string,
...
defmodule FlyMachinesApi.Schemas.SignalRequest do
  ...
  signal: %{
    type: :string,
    enum: ["SIGABRT", "SIGALRM", "SIGFPE", "SIGHUP", "SIGILL", "SIGINT", "SIGKILL", "SIGPIPE",
...
defmodule FlyMachinesApi.Schemas.fly.Static do
  @schema %{
...
defmodule FlyMachinesApi.Schemas.fly.dnsForwardRule do
...
defmodule FlyMachinesApi.Schemas.fly.DNSConfig do
  @schema %{
  options: %{
    type: :list,
    items: %{
...
defmodule FlyMachinesApi.Schemas.fly.HTTPResponseOptions do
